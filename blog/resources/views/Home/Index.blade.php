            ...
            <div class="posts-list js-posts">
                <div class="post post-layout-list" data-aos="fade-up">
                    <div class="status_list_item icon_kyubo">
                        <div class="status_user" style="background-image: url(/images/b0ce3f3cde0c084b6d42321b2dcbc407.jpeg);">
                            <div class="status_section">
                                <a href="/Home/detail" class="status_btn">交代是不可能交代的</a>
                    ...
                    <div class="postnormal review ">
                        <div class="post-container review-item">
                            <div class="row review-item-wrapper">
                                <div class="col-sm-3">
                                    <a rel="nofollow" href="detail.html">
                                        <div class="review-item-img" style="background-image: url({{URL::asset('/images/diego-ph-249471-2-800x1000.jpg')}});"></div>
                                    </a>
                                </div>
                            ...
                            <div class="review-bg-wrapper">
                                <div class="bg-blur" style="background-image: url(/images/diego-ph-249471-2-800x1000.jpg);"></div>
                            </div>
                        </div>
                ...
                <div class="post post-layout-list js-gallery" data-aos="fade-up">
                    <div class="post-album">
                        <div class="row content">
                            <div class="bg" style="background-image: url({{URL::asset('/images/IMG_0150.jpg')}});"></div>
                            ...
                            <div class="album-thumb-width flex-xs-middle">
                                <div class="row album-thumb no-gutter">
                                    <div class="col-xs-4"><img class="thumb" src="{{URL::asset('/images/IMG_0150-250x250.jpg')}}" /></div>
                                    <div class="col-xs-4"><img class="thumb" src="{{URL::asset('/images/IMG_0149-250x250.jpg')}}" /></div>
                                    <div class="col-xs-4"><img class="thumb" src="{{URL::asset('/images/IMG_0146-250x250.jpg')}}" /></div>
                                    <div class="col-xs-4"><img class="thumb" src="{{URL::asset('/images/IMG_0147-250x250.jpg')}}" /></div>
                                    <div class="col-xs-4"><img class="thumb" src="{{URL::asset('/images/IMG_0148-250x250.jpg')}}" /></div>
                                    <div class="col-xs-4">
                                        <a href="">5 pics</a>
                                    </div>
                                </div>
                    ...
                    <div class="postnormal review ">
                        <div class="post-container review-item">
                            <div class="row review-item-wrapper">
                                <div class="col-sm-3">
                                    <a rel="nofollow" href="detail.html">
                                        <div class="review-item-img" style="background-image: url({{URL::asset('/images/47fb3c_9afed6c259f94589881bd55376206366mv2_d_3840_5784_s_4_2-800x450.jpg')}});"></div>
                                    </a>
                                </div>
                                <div class="col-sm-9 flex-xs-middle">
                                    <div class="review-item-title">
                            ...
                            <div class="review-bg-wrapper">
                                <div class="bg-blur" style="background-image: url(/images/47fb3c_9afed6c259f94589881bd55376206366mv2_d_3840_5784_s_4_2-800x450.jpg);"></div>
                            </div>
                        </div>
                        <div class="post-container">
